            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a class="product-item" href="{{ route('cart') }}">
                        <img src="{{ asset('assets/images/products/2053-removebg-preview_cropped.png') }}"
                            class="img-fluid product-thumbnail" alt="Product 1">
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a class="product-item" href="{{ route('cart') }}">
                        <img src="{{ asset('assets/images/products/front-view-black-fragrance-with-golden-cap-white-isolated-desk-removebg-preview_cropped.png') }}"
                            class="img-fluid product-thumbnail" alt="Product 2">
                ...
                <div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
                    <a class="product-item" href="{{ route('cart') }}">
                        <img src="{{ asset('assets/images/products/28815-removebg-preview_cropped.png') }}"
