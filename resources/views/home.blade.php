...
@section('title', 'Furni - Modern Interior Design Studio')
            ...
            <div class="col-lg-7 mb-5 mb-lg-0">
                <div class="imgs-grid">
                    <div class="grid grid-1">
                        <img src="{{ asset('assets/images/img-grid-1.jpg') }}" alt="Untree.co" class="img-fluid">
                    </div>
                    <div class="grid grid-2">
                        <img src="{{ asset('assets/images/img-grid-2.jpg') }}" alt="Untree.co" class="img-fluid">
                    </div>
                    <div class="grid grid-3">
                        <img src="{{ asset('assets/images/img-grid-3.jpg') }}" alt="Untree.co" class="img-fluid">
                    </div>
                </div>
            </div>
