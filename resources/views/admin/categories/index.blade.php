                            ...
                            <div class="card" id="apiKeyList">
                                <div class="card-header d-flex align-items-center">
                                    ...
                                    <div class="d-flex gap-1 flex-wrap">
                                        ...
                                        <button type="button" class="btn btn-secondary create-btn" data-bs-toggle="modal" data-bs-target="#api-key-modal"><i class="ri-add-line align-bottom me-1"></i> Ajouter</button>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Créer Une nouvelle categorie</h5>
                        ...
                        <div class="modal-body">
                            <form autocomplete="off" action="" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="api-key-name" class="form-label">Nom de la categorie <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="api-key-name" name="name" placeholder="Entrez le nom de la categorie">
                                </div>
                                <div class="mb-3">
                                    <label for="description" class="form-label">Description de la categorie <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control"  id="description" name="description" placeholder="Entrez le nom de la categorie">
                                </div>
                                ...
                                <button type="button" class="btn btn-primary" id="createApi-btn">Enregistrer</button>
                            </form>
                        </div>
