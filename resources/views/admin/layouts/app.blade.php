            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.html" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ asset('admin/assets/images/logo_original.png') }}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ asset('admin/assets/images/logo_original.png') }}" alt="" height="17">
                        </span>
                    </a>
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="{{ route('dashboard') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('admin/assets/images/logo_original.png') }}" alt="" height="70">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('admin/assets/images/logo_original.png') }}" alt="" height="70">
                    </span>
