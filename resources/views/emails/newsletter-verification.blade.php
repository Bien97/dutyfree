...
<head>
    ...
    <style>
        ...
        .button { display: inline-block; padding: 12px 30px; background: #007bff; color: white; 
...
<body>
    <div class="container">
        ...
        <div class="footer">
            ...
            <p>Pour vous désinscrire : <a href="{{ route('newsletter.unsubscribe', $subscriber->token) }}">Cliquez ici</a></p>
        </div>
    </div>
</body>
</html>